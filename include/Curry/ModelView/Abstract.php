...
abstract class Curry_ModelView_Abstract {
	...
	abstract public function render(\Curry\Backend\AbstractLegacyBackend $backend, array $params);
	...
	public function dispatch(array $action, \Curry\Backend\AbstractLegacyBackend $backend, array $params)
	{
		$this->render($backend, $params);
	}
	
	public function show(\Curry\Backend\AbstractLegacyBackend $backend, $params = null)
	{
		if ($params === null)
			$params = $_GET;
		try {
