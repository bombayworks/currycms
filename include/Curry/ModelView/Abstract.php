...
abstract class Curry_ModelView_Abstract {
	...
	abstract public function render(Curry\AbstractLegacyBackend $backend, array $params);
	...
	public function dispatch(array $action, \Curry\AbstractLegacyBackend $backend, array $params)
	{
		$this->render($backend, $params);
	}
	
	public function show(\Curry\AbstractLegacyBackend $backend, $params = null)
	{
		if ($params === null)
			$params = $_GET;
		try {
